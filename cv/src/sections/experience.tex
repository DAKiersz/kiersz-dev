...
\begin{cventries}
  ...
  \cventry
    ...
    {
    \begin{cvitems}
		\item {A first promotion of all associate engineers in ASOS NI, and currently leased to Data Lake teams to provide consulting platform support.}
        \item {\textbf{Key Skills:} Azure (+\textbf{DevOps}), \textbf{Powershell (+DSC)}, \textbf{ARM/Bicep}, ADLS, C\#, Problem Solving, Agile, Support}
     \end{cvitems}
    }
  ...
  \cventry
    ...
    {Jan. 2022 - Mar. 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        ...
        \item {Passed \textbf{two Azure Fundamentals exams} in rapid succession and was offered a permanent position at ASOS.com following an interview.}
