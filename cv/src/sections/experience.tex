...
\begin{cventries}
  ...
  \cventry
  	{ASOS Plc.} % Organization
    {Platform Engineer} % Job title
    {Belfast, Northern Ireland} % Location
    {Jul. 2023 - Present} % Date(s)
    {
    \begin{cvitems}
		\item {A \textbf{first} promotion of all associate enginners in ASOS NI, currently leased to Data Lake domain to provide consulting platform support.}
        \item {\textbf{Key Skills:} Azure (+\textbf{DevOps}), \textbf{Powershell (+DSC)}, \textbf{ARM/Bicep}, Data Lake, C\#, Problem Solving, Agile, Support}
     \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
  	{South Eastern Regional College / ASOS Plc.} % Institution
